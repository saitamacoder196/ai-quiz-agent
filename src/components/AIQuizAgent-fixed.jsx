...
const AIQuizAgent = () => {
  ...
  // Claude API helper function with better error handling
  ...
  // Progress update with better logging
  ...
  // Extract English terms with error handling
...
Các câu hỏi phải:
- Bao quát các phần quan trọng của tài liệu: ${documentAnalysis?.main_topics?.join(', ') || 'nội dung chính'}
- Có độ khó ${documentAnalysis?.difficulty?.toLowerCase() || 'trung bình'}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* For brevity, I'll include the rest in a follow-up if needed */}
      </div>
    </div>
  );
};
